          ...
          <div className="tool">
            <div className="card">
              ...
              <div className="detail">
                ...
                <div className="card-content">Quickly perform adjustments to select the correct IOL power when moving an IOL from the capsule to the sulcus</div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="detail">
                ...
                <div className="card-content">Easily transpose between positive and negative cylinder</div>
              </div>
            </div>
          </div>
        </div>
